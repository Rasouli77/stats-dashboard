...
from ...camera_data import update_or_create_camera_data_hourly, get_custom_date_camera_data_hourly
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for ip in ips:
            if ping_ip(ip['ip']):
                try:
                    data = get_custom_date_camera_data_hourly(ip["ip"], "2025-10-11", "2025-10-27")
